  ...
  return (
    <footer className="footer">
      <div className="footer_column">
        <div className="footer_column-item dribble-info">
          <a href="https://dribbble.com/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 96 24"
              role="img"
              aria-labelledby="at3nsb2nfqwwft3z4ltp3v21jx9qjyuu"
              className="icon dribbble-wordmark"
            >
              <title id="at3nsb2nfqwwft3z4ltp3v21jx9qjyuu">
          ...
          <div className="social-links-container">
            ...
            <a href="http://twitter.com/dribbble">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                aria-labelledby="acc8gx76lu4vikbnoq2dr7fq2m4w49e2"
                role="img"
                viewBox="0 0 24 24"
                className="icon fill-current"
              >
                <title id="acc8gx76lu4vikbnoq2dr7fq2m4w49e2">
                  Twitter icon
                </title>
            ...
            <a href="http://facebook.com/dribbble">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                aria-labelledby="at872u89ygsfkxzjnb66tbtfg5nv8tve"
                role="img"
                viewBox="0 0 24 24"
                className="icon fill-current"
              >
                <title id="at872u89ygsfkxzjnb66tbtfg5nv8tve">
                  Facebook icon
                </title>
            ...
            <a href="http://www.pinterest.com/dribbble/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                aria-labelledby="ag5mhaatgg21d0bgcmsv3grxvozuuyj3"
                role="img"
                viewBox="0 0 24 24"
                className="icon fill-current"
              >
                <title id="ag5mhaatgg21d0bgcmsv3grxvozuuyj3">
                  Pinterest icon
                </title>
      ...
      <div className="footer_column">
        <div className="footer_column-item">
          ...
          <ul>
            ...
            <li>
              <a href="https://dribbble.com/shots">Explore design work</a>
            </li>
            <li>Design blog</li>
      ...
      <div className="footer_column">
        <div className="footer_column-item">
          ...
          <ul>
            <li>
              <a href="https://dribbble.com/jobs/new">Post a job opening</a>
            </li>
            <li>
